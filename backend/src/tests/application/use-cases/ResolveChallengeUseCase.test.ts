...
describe("ResolveChallengeUseCase", () => {
    ...
    describe("execute", () => {
        ...
        test("should resolve challenge successfully with a winner", async () => {
            ...
            expect(prisma.challenge.update)
        ...
        test("should throw error if winnerId is missing", async () => {
            ...
            await expect(
                ...
                new AppError("Debes especificar un winnerId", 400)
            );
        ...
        test("should throw error if challenge is not completed", async () => {
            ...
            await expect(
                ...
                new AppError(
                    "Solo se pueden resolver retos completados",
                    400
                )
            );
        ...
        test("should throw error if action is invalid", async () => {
            ...
            await expect(
                ...
                new AppError("Acción no válida", 400)
            );
